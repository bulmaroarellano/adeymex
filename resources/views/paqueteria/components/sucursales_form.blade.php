...
<div class="container sucursales-form">
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-12 ">
            <form
                action="{{ route('sucursales.update',  '') }}"
                method="POST">
                                ...
                                <div class="card-body d-flex flex-column justify-content-around">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-5">
                                            ...
                                            <label for="staticEmail" class="col-form-label ml-1">
                                                Descripción
                                            </label>
                                        </div>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-5">
                                            ...
                                            <label for="staticEmail" class="col-form-label ml-1">Telefono</label>

                                        </div>
                                        <div class="col-sm-7">
                                            <input type="tel" class="form-control" name="telefono" id="inputPassword"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-5">
                                            ...
                                            <label for="staticEmail" class="col-form-label ml-1">Email</label>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-5">
                                            ...
                                            <label for="staticEmail" class="col-form-label ml-1">Encargado</label>

                                        </div>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="encargado" id="inputPassword"
                                ...
                                <div class="card-body d-flex flex-column justify-content-around">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-5">
                                            ...
                                            <label for="staticEmail" class="col-form-label ml-1">Domicilio
                                                Linea1</label>
                                        </div>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-5">
                                            ...
                                            <label for="staticEmail" class="col-form-label ml-1">País</label>
